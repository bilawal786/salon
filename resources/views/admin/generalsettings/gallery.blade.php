                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($gallery as $row)
                                        <tr>
                                            <td>{{$row->id}}</td>
                                            <td>
                                                <img height="30px" src="{{asset($row->image)}}" alt="">
                                            </td>
                                            <td>
                                                <a href="{{route('gallery.delete', ['id' => $row->id])}}" id="delete" class="btn btn-sm btn-danger" data-toggle="tooltip" title="edit">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Ajouter une nouvelle Galerie</h5>
